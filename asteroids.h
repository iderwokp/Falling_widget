...
class  Asteroid: public Falling_widget{
	private:
		...
		Vec2d<double> m_hastighet{1.0, 45};
	...
	public:
		...
		Asteroid(const std::string& fn, SDL_Renderer* rend, int widget_width = 0, int widget_height = 0, int ybound=0, int xbound=0, int rot= 0): 
